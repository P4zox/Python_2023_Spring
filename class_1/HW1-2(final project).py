...
def infomation():
    ...
    table.insert("",index='end',text='<Call of Duty>Modern Warfare II 2022',values=('2100',Product_minus_button1,'2100'))
    table.insert("",index='end',text='<Rainbow 6> Siege',values=("540","1","540"))
    table.insert("",index='end',text='<Fortnite> Chapter 4 Season 1',values=("0","1","0"))
    table.insert("",index='end',text='<PUBG> Mobile',values=("0","1","0"))
    table.pack()
    info_win.mainloop()
...
totallabel.grid(row=7,column=5,columnspan=2,sticky=W)
